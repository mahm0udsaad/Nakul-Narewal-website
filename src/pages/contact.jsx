        ...
        <div className="flex flex-col justify-center h-[40vh] title mx-auto w-11/12">
          ...
          style={{border:"0"}}
           allowFullScreen
            ...
            <div className=" max-w-screen-xl sm:px-4 py-16 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-x-16 gap-y-8 ">
            <div className="flex justify-center sm:p-8 lg:col-span-3 lg:p-12 flex justify-center">
            <form action="" className="w-full sm:1/2 space-y-4 border mx-auto">
                    {/* First Div */}
